<header>
    <div class="topheader container-fluid">
        <a href="tel:(051)-602082"><i class="fa fa-phone"></i> ----------------</a>
    ...
    <!-- Menu de navegacion-->
    <nav class="fixed-top">
        <a href="{{route('index')}}" class="navbar-brand  "><img class="imagenlogo" id="imagenlogoid" src="img/logo.png"
                alt="logo"></a>
        ...
        <div class="bloque" id="bloques">
            ...
            <div class="bloque1">
                ...
                <div class="dropdown" id="dropdownid2">
                    <a class="btnbar icon dropbtn ileft" id="edropbtn" href="{{route('ahorros')}}">Ahorros</a>
                    <div class="dropdown-content">
                        <div class="container smaling">
                            <div class="card-group">
                                ...
                                <div class="card mb-3 bg-transparent"
                                    ...
                                    <div class="card-header bg-transparent text-center"
                                        style="border: transparent!important;">
                                        <div class="smtitle" style="color: #1A6CA7;"> Ahorro plazo fijo</div>
                                    </div>
                                    <div class="card-body" style="min-height:2rem; text-align: justify;">
                                        <p class="card-text ">
                                ...
                                <div class="card mb-3 bg-transparent"
                                    ...
                                    <div class="card-header bg-transparent text-center"
                                        style="border: transparent!important;">
                                        <div class="smtitle" style="color: #1A6CA7;"> Ahorro movil</div>
                                    </div>
                                    <div class="card-body" style="text-align: justify;min-height: 2rem;">
                                        <p class="card-text">
                ...
                <!-- GRUPO POSS -->
                <a class="btnbar" href="{{route('grupo')}}">Grupo Possible</a>
                <!-- CAMPAÑAS -->
